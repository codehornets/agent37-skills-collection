...
interviewers you should graduate to a real ATS (Applicant Tracking System) like [Lever](http://lever.co/). Make it clear
...
wrote a detailed post on [how to interview engineers](https://triplebyte.com/blog/how-to-interview-engineers).
...
wrote a [blog post](https://triplebyte.com/blog/does-it-make-sense-for-programmers-to-move-to-the-bay-area) talking
